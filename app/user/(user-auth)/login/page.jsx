...
import { useLogin } from '@/src/context/user_LoginContext';
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      const token = createUserToken({
        ...
        role: 'user' // User login gets 'user' role
      });
  ...
  // Function to create a simple JWT token
  function createUserToken(payload) {
    ...
    const signature = btoa('user-signature');
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/user/create-account" className="text-sm font-medium text-indigo-600 hover:text-indigo-700 transition-colors">
              Register Now
            </Link>
          </div>
        </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/user/forgot-password" className="text-sm font-medium text-indigo-600 hover:text-indigo-700 transition-colors">
                    Forgot password?
                  </Link>
                </div>

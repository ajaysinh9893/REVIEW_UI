...
export default function AdminUsersPage() {
  return (
    <div>
      ...
      <p className="text-gray-600 mb-8">Manage user accounts and permissions</p>
          ...
          <tbody>
            {[1, 2, 3, 4, 5].map((item) => (
              <tr key={item} className="border-b border-gray-100 hover:bg-gray-50">
                <td className="px-6 py-4 text-sm text-gray-900">User {item}</td>
                <td className="px-6 py-4 text-sm text-gray-600">user{item}@example.com</td>

    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          {loginStep === 'idle' && (
            <>
              ...
              <div className="text-center mb-10">
                ...
                <p className="text-base text-gray-500">Log in to your account to continue</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button className="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 transition-all">
          ...
          {/* Loading State */}
          {loginStep === 'loading' && (
            <div className="backdrop-blur-xl bg-white/90 rounded-2xl p-12 shadow-2xl border border-white/30 animate-in fade-in zoom-in duration-300">
          ...
          {/* Success State */}
          {loginStep === 'success' && (
            <div className="backdrop-blur-xl bg-white/90 rounded-2xl p-12 shadow-2xl border border-white/30 animate-in fade-in zoom-in duration-500">
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="relative">
                  ...
                  {/* Main Circle */}
                  <div className="relative w-24 h-24 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center shadow-2xl animate-in zoom-in duration-500">
                ...
                {/* Success Indicator */}
                <div className="flex items-center gap-2 px-4 py-2 bg-green-100 rounded-full animate-in fade-in duration-1000">
                  <div className="w-2 h-2 bg-green-600 rounded-full animate-pulse"></div>
                  <span className="text-green-800 text-sm font-semibold">Redirecting to dashboard...</span>
                </div>
              </div>
            </div>
          )}
